...
const blogPosts = [
  {
    ...
    content: `
      ...
      <p>Dans l'Évangile de Saint Matthieu, Jésus nous enseigne comment prier à travers le Notre Père, nous donnant un modèle qui couvre tous les aspects essentiels de la prière : la louange, la soumission à la volonté de Dieu, les demandes pour nos besoins quotidiens, le pardon et la protection.</p>
